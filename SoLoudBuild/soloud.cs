...
{
    public const int SO_NO_ERROR = 0;        // No error
    public const int INVALID_PARAMETER = 1;  // Some parameter is invalid
    public const int FILE_NOT_FOUND = 2;     // File not found
    public const int FILE_LOAD_FAILED = 3;   // File found, but could not be loaded
    public const int DLL_NOT_FOUND = 4;      // DLL not found, or wrong DLL
    public const int OUT_OF_MEMORY = 5;      // Out of memory
    public const int NOT_IMPLEMENTED = 6;    // Feature not implemented
    public const int UNKNOWN_ERROR = 7;      // Other error
}
...
public class Soloud : SoloudObject
{
	...
	[DllImport("soloud_x64", CallingConvention = CallingConvention.Cdecl)]
...
public class Bus : SoloudObject
{
    ...
    [DllImport("soloud_x64", CallingConvention = CallingConvention.Cdecl)]
    internal static extern void Bus_stopAllNonBusSounds(IntPtr aObjHandle);
    public void stopAllNonBusSounds()
	{
		Bus_stopAllNonBusSounds(objhandle);
	}
